//
//  TXClubExperienceMainViewController.m
//  HuaYiTianXia
//
...
@interface TXClubExperienceMainViewController ()<WMPageControllerDelegate>

@end

@implementation TXClubExperienceMainViewController
...
- (WMPageController *)p_defaultController {
    ...
    NSArray *classArray = @[@"TXClubExperienceViewController",@"TXClubExperienceViewController"];

//
//  TXClubExperienceChildViewController.m
//  HuaYiTianXia
//
...
@interface TXClubExperienceChildViewController ()<UITableViewDelegate,UITableViewDataSource,TXClubExperienceChildTableViewCellDelegate,WKUIDelegate,WKNavigationDelegate>
...
@implementation TXClubExperienceChildViewController
...
//        return tools;
        ...
        TXClubExperienceChildTableViewCell* tools = [tableView dequeueReusableCellWithIdentifier:reuseIdentifier forIndexPath:indexPath];
        tools.delegate = self;
...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerClass:[TXClubExperienceChildTableViewCell class] forCellReuseIdentifier:reuseIdentifier];

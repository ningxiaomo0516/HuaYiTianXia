//
//  TXClubExperienceViewController.m
//  HuaYiTianXia
//
...
#import "TXClubExperienceViewController.h"
#import "TXClubExperienceTableViewCell.h"
#import "TXCourseModel.h"
#import "TXClubExperienceChildViewController.h"

static NSString * const reuseIdentifier = @"TXClubExperienceTableViewCell";
@interface TXClubExperienceViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation TXClubExperienceViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    TXClubExperienceTableViewCell *tools = [tableView dequeueReusableCellWithIdentifier:reuseIdentifier];
    if (!tools) {
        tools = (TXClubExperienceTableViewCell *)[[[NSBundle mainBundle] loadNibNamed:reuseIdentifier owner:self options:nil] objectAtIndex:0];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    TXClubExperienceChildViewController *vc = [[TXClubExperienceChildViewController alloc] initCourseListModel:listModel];
    TTPushVC(vc);

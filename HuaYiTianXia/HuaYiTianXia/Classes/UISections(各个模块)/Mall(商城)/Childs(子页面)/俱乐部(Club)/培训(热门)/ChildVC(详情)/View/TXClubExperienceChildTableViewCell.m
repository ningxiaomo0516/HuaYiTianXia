//
//  TXClubExperienceChildTableViewCell.m
//  HuaYiTianXia
//
...
#import "TXClubExperienceChildCollectionViewCell.h"

static NSString* reuseIdentifier = @"TXClubExperienceChildCollectionViewCell";
@interface TXClubExperienceChildTableViewCell()<UICollectionViewDelegate, UICollectionViewDataSource>
...
@end
@implementation TXClubExperienceChildTableViewCell
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    TXClubExperienceChildCollectionViewCell *tools = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[TXClubExperienceChildCollectionViewCell class] forCellWithReuseIdentifier:reuseIdentifier];

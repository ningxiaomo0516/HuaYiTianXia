//
//  TXClubChildRecommendedViewController.m
//  HuaYiTianXia
//
...
#import "TXClubExperienceChildTableViewCell.h"
...
static NSString * const reuseIdentifier         = @"TXClubExperienceChildTableViewCell";
static NSString * const reuseIdentifierInfo     = @"TXClubChildRecommendedTableViewCell";
static NSString * const reuseIdentifierBanner   = @"TXMallGoodsBannerTableViewCell";
@interface TXClubChildRecommendedViewController ()<UITableViewDelegate,UITableViewDataSource,TXClubExperienceChildTableViewCellDelegate,WKUIDelegate,WKNavigationDelegate>
...
@implementation TXClubChildRecommendedViewController
- (id)initListModel:(MallClubListModel *)listModel{
    if ( self = [super init] ){
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if(indexPath.section==0){
        ...
        TXClubChildRecommendedTableViewCell *tools = [tableView dequeueReusableCellWithIdentifier:reuseIdentifierInfo forIndexPath:indexPath];
...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerClass:[TXClubChildRecommendedTableViewCell class] forCellReuseIdentifier:reuseIdentifierInfo];

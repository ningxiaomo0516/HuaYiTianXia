//
//  TXClubRecommendedViewController.m
//  HuaYiTianXia
//
...
#import "TXClubRecommendedTableViewCell.h"
...
static NSString * const reuseIdentifier = @"TXClubRecommendedTableViewCell";
@interface TXClubRecommendedViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation TXClubRecommendedViewController
...
- (void) requestData{
    ...
    [SCHttpTools postWithURLString:kHttpURL(@"flightproduct/flightProductPage") parameter:parameter success:^(id responseObject) {
        ...
        TXMallClubModel *model = [TXMallClubModel mj_objectWithKeyValues:result];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    TXClubRecommendedTableViewCell* tools = [tableView dequeueReusableCellWithIdentifier:reuseIdentifier forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    MallClubListModel *listModel = self.dataArray[indexPath.row];
...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerClass:[TXClubRecommendedTableViewCell class] forCellReuseIdentifier:reuseIdentifier];

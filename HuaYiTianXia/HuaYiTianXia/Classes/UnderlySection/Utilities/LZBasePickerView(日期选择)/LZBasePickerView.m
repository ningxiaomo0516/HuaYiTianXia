...
- (UIView *)topView {
    if (!_topView) {
        ...
        _topView.backgroundColor = [UIColor lz_colorWithHex:0xFDFDFD];
    }
    return _topView;
}
...
- (UIButton *)leftBtn {
    if (!_leftBtn) {
        ...
        _leftBtn.autoresizingMask = UIViewAutoresizingFlexibleBottomMargin | UIViewAutoresizingFlexibleLeftMargin;
...
- (UIView *)lineView {
    if (!_lineView) {
        ...
        _lineView.backgroundColor  = kColorWithRGB(227, 227, 229);

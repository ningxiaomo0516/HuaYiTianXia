...
@interface TTPickerHeaderView ()<UICollectionViewDelegate,UICollectionViewDataSource>
@property (nonatomic , strong) UICollectionView * collectionView;
@property (nonatomic , strong) UIView * animationline;
@end
@implementation TTPickerHeaderView
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    if ([self.dalegate respondsToSelector:@selector(tt_pickerHeaderView:didSelcetIndex:)]) {
        [self.dalegate tt_pickerHeaderView:self didSelcetIndex:indexPath.row];
    }

...
- (void)initAttributes {
    ...
    self.separatorColor = kLinerViewColor;
...
- (CAShapeLayer *)creatSeparatorLayer:(CGPoint)position color:(UIColor *)color {
    ...
    UIBezierPath *bezierPath = [[UIBezierPath alloc] init];
    [bezierPath moveToPoint:CGPointMake(0, 0)];
    [bezierPath addLineToPoint:CGPointMake(0, self.bounds.size.height - 20)];
    [bezierPath closePath];
    
    // separatorLayer
    CAShapeLayer *separatorLayer = [[CAShapeLayer alloc] init];
    separatorLayer.path = bezierPath.CGPath;
    separatorLayer.lineWidth = 0.7;

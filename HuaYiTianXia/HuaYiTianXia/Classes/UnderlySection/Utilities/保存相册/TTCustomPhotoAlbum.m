...
@interface TTCustomPhotoAlbum() <NSCopying, NSMutableCopying>
/// 当前App对应的自定义相册
...
@implementation TTCustomPhotoAlbum
static TTCustomPhotoAlbum *_shareInstance;

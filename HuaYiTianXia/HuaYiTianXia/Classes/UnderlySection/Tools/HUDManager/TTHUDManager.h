...
#pragma mark - 提示图片
/**
 在 KeyWindow 展示 成功提示,默认成功图片在 TTHUDImages.bundle 中, - 1秒消失
 */
+ (void)showSuccessHUD;

/**
 在 KeyWindow 展示 有文本的成功提示,默认成功图片在 TTHUDImages.bundle 中, - 1秒消失
...
/**
 在 View 展示 成功提示,默认成功图片在 TTHUDImages.bundle 中, - 1秒消失
 */
+ (void)showSuccessTipHUDInView:(NSString *)message;

/**
 在 KeyWindow 展示 失败提示,默认失败图片在 TTHUDImages.bundle 中, - 1秒消失
 */
+ (void)showErrorHUD;

/**
 在 KeyWindow 展示 有文本的失败提示,默认失败图片在 TTHUDImages.bundle 中, - 1秒消失
...
/**
 在 KeyWindow 展示 信息提示,默认信息图片在 TTHUDImages.bundle 中, - 1秒消失
...
/**
 在 view 展示 信息提示,默认信息图片在 TTHUDImages.bundle 中, - 1秒消失
...
/**
 在 KeyWindow 展示 警告提示,默认警告图片在 TTHUDImages.bundle 中, - 1秒消失
...
/**
 在 View 展示 警告提示,默认警告图片在 TTHUDImages.bundle 中, - 1秒消失
 
 @param message 提示语
 */
+ (void)showWarningTipHUDInView:(NSString *)message;

#pragma mark - 自定义图片+提示语(图片需要导入 'TTHUDImages.bundle' 包中)
/**
 在 KeyWindow 展示自定义图片 - 图片需要导入 'TTHUDImages.bundle' 包中
...
/**
 在 View 展示自定义图片 - 图片需要导入 'TTHUDImages.bundle' 包中
...
/**
 在 KeyWindow 展示自定义图片 - 图片需要导入 'TTHUDImages.bundle' 包中 - 不自动移除
...
/**
 在 View 展示自定义图片 - 图片需要导入 'TTHUDImages.bundle' 包中 - 不自动移除
